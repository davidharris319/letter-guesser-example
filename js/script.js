...
const initializeGame = () => {
    ...
    */ 
    ...
    userGuessesElement();
    computerChoice();
    lettersContainerElement(renderLetters());
};
...
const userGuessesElement = () => (document.getElementById('user-guesses').innerHTML = userGuesses.join(', '));
...
document.querySelector('#letter-buttons-container').addEventListener('click', function(event) {
